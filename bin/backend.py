...
from bin import sqlite_functions as sql_f
# - - - - - - - - - - - - - - - - - - - -
...
def html_log():
    ...
    filepath = os.path.abspath(os.path.join(os.getcwd(), os.pardir)) + d + "Log.csv"
    ...
    if os.path.isfile(filepath):
        ...
        html_open(os.path.abspath(os.path.join(os.getcwd(), os.pardir)) + d + "Log.html")

    else:
        messagebox.showwarning("Unable to load", "Log file not found.\n" +
...
def html_readme():
    """
        ...
        args:
            none.
    """
    imgref = r".\bin\images\Donate.png"
    ...
    html_open(os.path.abspath(os.path.join(os.getcwd(), os.pardir)) +
              d + "readme.html")
...
def db_open():
    ...
    """
    try:
        database_path = os.path.abspath(os.path.join(os.getcwd(), os.pardir)) + \
                                        d + "data" + d + "STORAGE.db"

        if os.path.isfile(database_path):
            os.system("DBBrowser.exe " + database_path)
...
def mainprocess(root, monitor, listbox, delay=60):
    ...
    try:
        ...
        dbpath = os.path.abspath(os.path.join(os.getcwd(), os.pardir)) + d + "data" + d
